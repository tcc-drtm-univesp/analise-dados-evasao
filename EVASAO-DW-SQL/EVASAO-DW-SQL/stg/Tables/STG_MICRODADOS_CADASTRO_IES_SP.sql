CREATE TABLE [stg].[STG_MICRODADOS_CADASTRO_IES_SP] (
    ...
    [NO_REGIAO_IES]                  VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [CO_REGIAO_IES]                  INT           NULL,
    [NO_UF_IES]                      VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [SG_UF_IES]                      VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [CO_UF_IES]                      INT           NULL,
    [NO_MUNICIPIO_IES]               VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [CO_MUNICIPIO_IES]               INT           NULL,
    [IN_CAPITAL_IES]                 INT           NULL,
    [NO_MESORREGIAO_IES]             VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
    [CO_MESORREGIAO_IES]             INT           NULL,
    [NO_MICRORREGIAO_IES]            VARCHAR (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
