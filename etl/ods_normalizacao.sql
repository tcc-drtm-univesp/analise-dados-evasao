...
ALTER TABLE dw.DIM_TIPO_ORGANIZACAO_ACADEMICA		ALTER COLUMN TP_ORGANIZACAO_ACADEMICA		INT NOT NULL	
ALTER TABLE dw.DIM_TIPO_CATEGORIA_ADMINISTRATIVA	ALTER COLUMN TP_CATEGORIA_ADMINISTRATIVA	INT NOT NULL	
...
select * from  DW.FTO_DADOS_FLUXO where 
