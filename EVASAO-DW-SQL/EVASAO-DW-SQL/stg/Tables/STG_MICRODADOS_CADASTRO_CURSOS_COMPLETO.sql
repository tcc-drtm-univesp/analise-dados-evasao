CREATE TABLE [stg].[STG_MICRODADOS_CADASTRO_CURSOS_COMPLETO] (
    [NU_ANO_CENSO]                 INT            NULL,
    [NO_REGIAO]                    NVARCHAR (200) COLLATE Latin1_General_CI_AI NULL,
    [CO_REGIAO]                    INT            NULL,
    [NO_UF]                        NVARCHAR (200) COLLATE Latin1_General_CI_AI NULL,
    [SG_UF]                        NVARCHAR (200) COLLATE Latin1_General_CI_AI NULL,
    [CO_UF]                        INT            NULL,
    [NO_MUNICIPIO]                 NVARCHAR (200) COLLATE Latin1_General_CI_AI NULL,
